...
import controller.nequi;
 ...
 private void iniciosesion(HttpServletRequest req, HttpServletResponse resp) { 
        ...
        try { 
            ...
            rd.inicarsesion(r); 
            dp.setIdUsuario(r.getIdUsuario());
            System.out.println(r.getIdUsuario());
            System.out.println("retorno a"+r.getValidacion());
            if(r.getValidacion()==1){
     ...
     private void iniciosesion_nq(HttpServletRequest req, HttpServletResponse resp) { 
        ...
        try { 
            ...
            System.out.println("consulta  insertada correctamente");
            rd.inicarsesion(r);
            System.out.println("id usuario"+r.getIdUsuario());
            nq.setIdUsuario(r.getIdUsuario());
            
            System.out.println( "pruebas nq usuario"+nq.getIdUsuario());
            if(r.getValidacion()==1){
           ...
           // validar(req, resp); 
            ...
            System.out.println("Error en la consulta de inicio de sesion  del registro "+e.getMessage().toString());
        }
