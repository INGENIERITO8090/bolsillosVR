...
nequiVo  nq=new nequiVo();
 ...
 public int idCu(int id,HttpServletRequest req ,HttpServletResponse resp){
          nq.setIdUsuario(id);
          idC=nq.getIdUsuario();   
           System.out.println("id Cuenta usuario"+nq.getIdUsuario());
    
        return nq.getIdUsuario();
 } 

 public Object idc(int id,nequiVo nq){
  nq.setIdCuenta(id);
    return nq;
 }
  ...
  private void recarga(HttpServletRequest req, HttpServletResponse resp) {
    try {
        nq.setSaldo(rdnq.consultar_saldo_p(nq.getIdUsuario()));
        System.out.println("saldo en recarga");
         int  saldo_p; 
    ...
    private void consultar_saldo(HttpServletRequest req, HttpServletResponse resp) {
      try { 
        nq.setSaldo(rdnq.consultar_saldo_p(nq.getIdUsuario()));
        req.setAttribute("saldo_t",nq.getSaldo());
